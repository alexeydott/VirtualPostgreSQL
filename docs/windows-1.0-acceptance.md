[← Previous: Release notes](release-notes-1.0.0.md) · [Back to README](../README.md)
...
| 19 | Query profile | `vps_query_profile_test` | PASS |
...
- [Release notes](release-notes-1.0.0.md) — shipped capabilities and limits.

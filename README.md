...
the extension ABI, secure connection/session runtime, async client port and
versioned PostgreSQL table metadata.
...
```powershell
pwsh -NoProfile -File scripts/ci/run-stage5.ps1
```

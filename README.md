...
versioned PostgreSQL metadata, the end-to-end read-only virtual table path and
conservative predicate/projection/order/limit pushdown.
...
```powershell
pwsh -NoProfile -File scripts/ci/run-stage7.ps1
```

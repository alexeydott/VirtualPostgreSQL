...
#define VPS_ARGUMENT_SCHEMA_POLICY \
    (UINT64_C(1) << VPS_ARGUMENT_ID_SCHEMA_POLICY)
#define VPS_ARGUMENT_QUERY_INDEXES \
    (UINT64_C(1) << VPS_ARGUMENT_ID_QUERY_INDEXES)
#define VPS_ARGUMENT_QUERY_MATERIALIZATION \
    (UINT64_C(1) << VPS_ARGUMENT_ID_QUERY_MATERIALIZATION)
#define VPS_ARGUMENT_ISOLATION \
    (UINT64_C(1) << VPS_ARGUMENT_ID_ISOLATION)
#define VPS_ARGUMENT_TRANSACTION_READ_ONLY \
    (UINT64_C(1) << VPS_ARGUMENT_ID_TRANSACTION_READ_ONLY)
...
typedef enum VpsArgumentEnumValue {
    ...
    VPS_ARGUMENT_ENUM_GEOMETRY_SPATIALITE,
    VPS_ARGUMENT_ENUM_GEOMETRY_NONE,
    ...
    VPS_ARGUMENT_ENUM_SCHEMA_STRICT,
    VPS_ARGUMENT_ENUM_SCHEMA_REFRESH,
    VPS_ARGUMENT_ENUM_MATERIALIZATION_OFF,
    VPS_ARGUMENT_ENUM_MATERIALIZATION_MEMORY,
    VPS_ARGUMENT_ENUM_MATERIALIZATION_TEMP,

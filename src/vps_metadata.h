...
typedef enum VpsCatalogQuery {
    ...
    VPS_CATALOG_QUERY_RELATIONS_FUNCTION = 5,
    VPS_CATALOG_QUERY_TABLE_INFO_FUNCTION = 6,
    VPS_CATALOG_QUERY_INDEX_LIST_FUNCTION = 7,
    VPS_CATALOG_QUERY_INDEX_INFO_FUNCTION = 8,
    VPS_CATALOG_QUERY_TYPE_INFO_FUNCTION = 9,
    VPS_CATALOG_QUERY_EXTENSIONS_FUNCTION = 10,
    VPS_CATALOG_QUERY_COUNT = 11
} VpsCatalogQuery;
